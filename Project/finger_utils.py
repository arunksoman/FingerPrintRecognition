...
import glob
import os
# from .fprmodules.enhancement.image_enhance import image_enhance as fe
...
#     '''
#     print(file_names)
#     file_names = [img for img in glob.glob(IMAGES_PATH + "\*.bmp")]
#     print(file_names)
#     # file_names.sort()
#     return file_names
...
def enhance_image(image):
    # print(fe(image))
    if len(fe(image)) == 4:
        img_e, mask1, orientim1, freqim1 = fe(image)
